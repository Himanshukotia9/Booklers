        ...
        <nav className='flex justify-between items-center px-2 sm:px-6'>
            ...
            <div className='flex items-center md:gap-16 gap-4'>
                ...
                <div className='relative sm:w-72 w-40 space-x-1'>
                    <IoSearchOutline className='absolute inline-block left-2 md:left-3 inset-y-2'/>
            ...
            <div className='relative flex items-center md:space-x-3 space-x-2'>
                                        ...
                                        <ul className='py-2'>
                                            {
                                                navigation.map((item)=> (<li key={item.name} onClick={() => setIsDropdownOpen(false)}>
                                                    <Link to={item.path} className='block px-4 py-2 text-sm hover:bg-gray-100'>{item.name}</Link>
                                                </li>))
                                            }
                                        </ul>
                                    </div>
                ...
                <Link to="/cart" className='bg-primary p-1 sm:px-6 px-2 flex rounded-md items-center'>
