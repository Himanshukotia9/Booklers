      ...
      <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8'>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='mb-4'>
                ...
                <input {...register("username", { required: true })} type="text" name='username' id='username' placeholder='Username' className='shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-md'/>
            </div>
            <div className='mb-4'>
            ...
            <div className=''>
                <button className='bg-blue-500 hover:bg-blue-700 w-full text-white font-bold py-2 px-6 rounded focus:outline-none transition-colors'>Login</button>
            </div>
        </form>
